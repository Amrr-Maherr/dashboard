...
export default function SubcategoriesPage() {
  ...
  const { data: subcategoriesResponse, isLoading, error } = useSubcategories(pageIndex, pageSize)
      ...
      <ProtectedRoute>
        <SidebarProvider>
          ...
          <SidebarInset>
            <SiteHeader />
            <div className="flex flex-1 flex-col items-center justify-center">
              <div className="text-lg text-red-500">Error loading subcategories</div>
            </div>
          </SidebarInset>
        </SidebarProvider>
      </ProtectedRoute>
